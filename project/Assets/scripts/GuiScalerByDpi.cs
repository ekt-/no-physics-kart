...
namespace UnityEngine
{
    ...
    /// Usage:
    ///
    /// (optional) Call GuiScalerByDpi.Initialize() in Start(), Awake() or OnEnable() (only needed once)
    /// Call GuiScalerByDpi.Begin() at the top of your OnGUI() methods
    /// Call GuiScalerByDpi.End() at the bottom of your OnGUI() methods
    ///
    /// WARNING: If you don't match Begin() and End() strange things will happen.
    /// </summary>
    public static class GuiScalerByDpi
    {
